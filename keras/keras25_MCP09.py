...
filepath = './_ModelCheckPoint/k25/9/'
mcp = ModelCheckpoint(monitor= 'val_loss', mode='auto', filepath=''.join([filepath,
                                                                          ' ',date,' ',filename]), save_best_only=True)
...
model.fit(x_train, y_train, epochs = 45, batch_size=200, verbose=1, validation_split=0.2,
          callbacks=mcp
          )
