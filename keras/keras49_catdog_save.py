...
np.save('d:/study_data/_save/_npy/cat_dog_2/keras49_06_train_x.npy', arr=xy_train[0][0])
np.save('d:/study_data/_save/_npy/cat_dog_2/keras49_06_train_y.npy', arr=xy_train[0][1])
np.save('d:/study_data/_save/_npy/cat_dog_2/keras49_06_test_x.npy', arr=xy_test[0][0])
np.save('d:/study_data/_save/_npy/cat_dog_2/keras49_06_test_y.npy', arr=xy_test[0][1])
