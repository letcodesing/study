...
# tf.random.set_seed(31) #버전에 따라 다른듯
...
#트레인셋 구조확인 테스트셋과 비교 판다스 이용
# print(train_set. unique()) #판다스 유니크는 특정 열에 사용되는듯 
...
x = train_set.drop(['PassengerId', 'Survived', 'Name', 'Sex', 'Ticket', 'Cabin','Embarked'], axis=1)
