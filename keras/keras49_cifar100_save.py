...
from tensorflow.keras.datasets import fashion_mnist,mnist,cifar100
...
np.save('d:/study_data/_save/_npy/cifar100/keras49_04_train_x.npy', arr=xy_train[0][0])
np.save('d:/study_data/_save/_npy/cifar100/keras49_04_train_y.npy', arr=xy_train[0][1])
np.save('d:/study_data/_save/_npy/cifar100/keras49_04_test_x.npy', arr=xy_test[0][0])
np.save('d:/study_data/_save/_npy/cifar100/keras49_04_test_y.npy', arr=xy_test[0][1])
