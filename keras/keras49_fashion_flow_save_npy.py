...
np.save('d:/study_data/_save/_npy/fashion/keras49_01_train_x.npy', arr=xy_train[0][0])
np.save('d:/study_data/_save/_npy/fashion/keras49_01_train_y.npy', arr=xy_train[0][1])
np.save('d:/study_data/_save/_npy/fashion/keras49_01_test_x.npy', arr=xy_test[0][0])
np.save('d:/study_data/_save/_npy/fashion/keras49_01_test_y.npy', arr=xy_test[0][1])
