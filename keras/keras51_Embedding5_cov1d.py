...
from keras.layers import Dense, Input, LSTM, GRU, Reshape, Conv1D, Embedding, Flatten, ConvLSTM1D #인풋레이어에서 많이 쓴다
...
model.fit(np.array(pad_x),np.array(labels), epochs=1, batch_size=1)
